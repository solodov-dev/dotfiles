...
beautiful.wallpaper = "/home/solo/Pictures/wallpaper.png"
beautiful.bg_focus = "#689d6a"
beautiful.border_focus = "#689d6a"
beautiful.font = "Fira Code Nerd Font 13"
```
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey }, "d", function() awful.spawn.with_shell("rofi -show drun -show-icons &>> /dev/null") end,
