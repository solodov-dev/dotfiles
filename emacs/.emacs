...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-bullets evil-commentary evil-magit magit counsel-projectile projectile hydra evil-collection evil general ivy-rich which-key rainbow-delimiters solarized-theme doom-modeline ivy command-log-mode use-package)))
(custom-set-faces
